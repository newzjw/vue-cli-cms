          ...
          <div class="mui-card-content-inner">
            ...
            <div class="info">
              ...
              <p>
                ...
                <!-- 问题：如何从购物车中获取商品的数量呢 -->
                <!-- 1. 先创建一个空对象，然后循环购物车中所有商品的数据，把当前循环这条商品的 Id作为对象的属性名，count值作为 对象的 属性值，
...
import numbox from '@/common/shopcar_numbox.vue'
...
export default {
  ...
  methods: {
    getGoodsList () {
      // 1. 获取到 store 中所有的商品的Id，然后拼接出一个 用逗号分隔的 字符串（参考api文档）
      var idArr = []
    ...
    remove (id, index) {
      // 点击删除，把商品从store中根据传递的Id删除，同时把当前组件中的goodslist对应要删除的那个商品，使用 index 来删除
